...
output_root = Path('/arc/project/st-ilker-1/undergrad-capstone-2025/SBME-Capstone-2025-Breast-Lesion-MRI-Analysis/EfficientNet/Odelia_Data')
...
print(f"Dataset streamed and saved successfully! Saved {samples_saved} samples.")